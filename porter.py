...
Cleanup to use more idiomatic Python by Geoff Kuenning (geoff@cs.hmc.edu),
leading to:
...
class PorterStemmer:
    ...
    def cvc(self, i):
        ...
        consonant - vowel - consonant and also if the second consonant
        is not w, x, or y. This is used when trying to restore an e at
    ...
    def step4(self):
        ...
        if self.b[self.k - 1] == 'a':
            ...
            if self.ends("ion") \
              and (self.b[self.j] == 's' or self.b[self.j] == 't'):
                pass
            elif self.ends("ou"):
                pass
            # takes care of -ous
...
def create_stem(word):
    """This is the primary stemming function:
       create_stem takes in a word--a string--and returns a string
       (the stem of word) according to the Porter stemmer.
